...
export const CountdownStyle = styled.div`
    ...
    ///THE FOLLOWE FORM --- ///THE FOLLOWE FORM  --///THE FOLLOWE FORM
    ...
    //xmas messaeg overlay-- //xmas messaeg overlay--//xmas messaeg overlay
    //xmas messaeg overlay-- //xmas messaeg overlay--//xmas messaeg overlay
    //xmas messaeg overlay-- //xmas messaeg overlay--//xmas messaeg overlay
    .message-cont {
        position: absolute;
...
lg (for laptops and desktops - screens equal to or greater than 1200px wide) */
    ...
    .lightbox-close-btn {
        ...
        top: 15px;
        left: 15px;
        z-index: 2; // background-color: rgba(white, .25);
        // display: inline;
        // padding: .5rem .7rem;
        border-radius: 100px;
        cursor: pointer;
        ...
        &:hover {
            animation: turny-turn 1s cubic-bezier(0.36, 0.07, 0.19, 0.97) both; // color: orange;
            font-weight: 500;
        }
    }
    ...
    .example-page-message-center {
        ...
        p {
            ...
            @include media-sml {
                @include fontSize(30px); // text-align: center;
            }
        }
    }
`
